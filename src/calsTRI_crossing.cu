...
__global__ void calTRI(float *confx, float *confy, float *confz, double *out){
	...
	volatile float Ax, Ay, Az, Bx, By, Bz, Cx, Cy, Cz;
	volatile float det,div;
  ...
  Cz = 0;
	z=0;
	Ax = confx[cals_coo(z, by, bx)];
	Ay = confy[cals_coo(z, by, bx)];
	Az = confz[cals_coo(z, by, bx)];
	Bx = confx[cals_coo(z, ty, tx)];
	By = confy[cals_coo(z, ty, tx)];
	Bz = confz[cals_coo(z, ty, tx)];
  Cx = Ay * Bz - Az * By;
  Cy = Az * Bx - Ax * Bz;
	det += Cx * Cx; //mapping det : Mxx
	div += Cy * Cy; //mapping div : Myy
  Cz += Cx * Cy; //mapping Cz : Mxy
	Ax = confx[cals_coo(z, ty, bx)];
	Ay = confy[cals_coo(z, ty, bx)];
	Az = confz[cals_coo(z, ty, bx)];
  Cx = Ay * Bz - Az * By;
  Cy = Az * Bx - Ax * Bz;
	det += Cx * Cx; //mapping det : Mxx
	div += Cy * Cy; //mapping div : Myy
  Cz += Cx * Cy; //mapping Cz : Mxy
	Ax = confx[cals_coo(z, by, tx)];
	Ay = confy[cals_coo(z, by, tx)];
	Az = confz[cals_coo(z, by, tx)];
  Cx = Ay * Bz - Az * By;
  Cy = Az * Bx - Ax * Bz;
	det += Cx * Cx; //mapping det : Mxx
	div += Cy * Cy; //mapping div : Myy
  ...
  Cy = Az * Bx - Ax * Bz;
	...
	div += Cy * Cy; //mapping div : Myy
  Cz += Cx * Cy; //mapping Cz : Mxy
	Ax = confx[cals_coo(z, typ, bx)];
	Ay = confy[cals_coo(z, typ, bx)];
	Az = confz[cals_coo(z, typ, bx)];
  Cx = Ay * Bz - Az * By;
  Cy = Az * Bx - Ax * Bz;
	det += Cx * Cx; //mapping det : Mxx
	div += Cy * Cy; //mapping div : Myy
  ...
  Cy = Az * Bx - Ax * Bz;
	...
	div += Cy * Cy; //mapping div : Myy
  Cz += Cx * Cy; //mapping Cz : Mxy
	Ax = confx[cals_coo(z, typ2, bx)];
	Ay = confy[cals_coo(z, typ2, bx)];
	Az = confz[cals_coo(z, typ2, bx)];
  Cx = Ay * Bz - Az * By;
  Cy = Az * Bx - Ax * Bz;
	det += Cx * Cx; //mapping det : Mxx
	div += Cy * Cy; //mapping div : Myy
  ...
  Cy = Az * Bx - Ax * Bz;
	...
	div += Cy * Cy; //mapping div : Myy
  Cz += Cx * Cy; //mapping Cz : Mxy
	Ax = confx[cals_coo(z, by, txp)];
	Ay = confy[cals_coo(z, by, txp)];
	Az = confz[cals_coo(z, by, txp)];
  Cx = Ay * Bz - Az * By;
  Cy = Az * Bx - Ax * Bz;
	det += Cx * Cx; //mapping det : Mxx
	div += Cy * Cy; //mapping div : Myy
  ...
  Cy = Az * Bx - Ax * Bz;
	...
	div += Cy * Cy; //mapping div : Myy
  Cz += Cx * Cy; //mapping Cz : Mxy
	Ax = confx[cals_coo(z, by, txp2)];
	Ay = confy[cals_coo(z, by, txp2)];
	Az = confz[cals_coo(z, by, txp2)];
  Cx = Ay * Bz - Az * By;
  Cy = Az * Bx - Ax * Bz;
	det += Cx * Cx; //mapping det : Mxx
	div += Cy * Cy; //mapping div : Myy
  ...
  Cz += Cx * Cy; //mapping Cz : Mxy
	...
	Ay = confy[cals_coo(z, typ, txp)];
	Az = confz[cals_coo(z, typ, txp)];
	Bx = confx[cals_coo(z, typ2, txp2)];
	By = confy[cals_coo(z, typ2, txp2)];
	Bz = confz[cals_coo(z, typ2, txp2)];
  Cx = Ay * Bz - Az * By;
  Cy = Az * Bx - Ax * Bz;
	det += Cx * Cx; //mapping det : Mxx
	div += Cy * Cy; //mapping div : Myy
