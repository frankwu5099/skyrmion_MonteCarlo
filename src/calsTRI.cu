...
__global__ void calTRI(float *confx, float *confy, float *confz, double *out){
	...
	//Bottom-left corner
	sD[y][x] -= confx[coo2D((ty+1), tx)] * ( BXMxx * confx[coo2D((ty+1), bx)] + BYMxx * confx[coo2D(ty, tx)] + BWMxx * confx[coo2D(ty, bx)])\
		         +confx[coo2D((ty+1), tx)] * ( BXMxy * confy[coo2D((ty+1), bx)] + BYMxy * confy[coo2D(ty, tx)] + BWMxy * confy[coo2D(ty, bx)])\
		         +confx[coo2D((ty+1), tx)] * ( BXMxz * confz[coo2D((ty+1), bx)] + BYMxz * confz[coo2D(ty, tx)] + BWMxz * confz[coo2D(ty, bx)])\
		         +confy[coo2D((ty+1), tx)] * ( BXMyx * confx[coo2D((ty+1), bx)] + BYMyx * confx[coo2D(ty, tx)] + BWMyx * confx[coo2D(ty, bx)])\
		         +confy[coo2D((ty+1), tx)] * ( BXMyy * confy[coo2D((ty+1), bx)] + BYMyy * confy[coo2D(ty, tx)] + BWMyy * confy[coo2D(ty, bx)])\
		         +confy[coo2D((ty+1), tx)] * ( BXMyz * confz[coo2D((ty+1), bx)] + BYMyz * confz[coo2D(ty, tx)] + BWMyz * confz[coo2D(ty, bx)])\
		         +confz[coo2D((ty+1), tx)] * ( BXMzx * confx[coo2D((ty+1), bx)] + BYMzx * confx[coo2D(ty, tx)] + BWMzx * confx[coo2D(ty, bx)])\
		         +confz[coo2D((ty+1), tx)] * ( BXMzy * confy[coo2D((ty+1), bx)] + BYMzy * confy[coo2D(ty, tx)] + BWMzy * confy[coo2D(ty, bx)])\
		         +confz[coo2D((ty+1), tx)] * ( BXMzz * confz[coo2D((ty+1), bx)] + BYMzz * confz[coo2D(ty, tx)] + BWMzz * confz[coo2D(ty, bx)] - A * confz[coo2D((ty+1), tx)]);
	//Top-right corner
	sD[y][x] -= confx[coo2D(ty, tx+1)] * ( BXMxx * confx[coo2D(ty, tx)] + BYMxx * confx[coo2D(by, tx+1)] + BWMxx * confx[coo2D(by, tx)])\
		         +confx[coo2D(ty, tx+1)] * ( BXMxy * confy[coo2D(ty, tx)] + BYMxy * confy[coo2D(by, tx+1)] + BWMxy * confy[coo2D(by, tx)])\
		         +confx[coo2D(ty, tx+1)] * ( BXMxz * confz[coo2D(ty, tx)] + BYMxz * confz[coo2D(by, tx+1)] + BWMxz * confz[coo2D(by, tx)])\
		         +confy[coo2D(ty, tx+1)] * ( BXMyx * confx[coo2D(ty, tx)] + BYMyx * confx[coo2D(by, tx+1)] + BWMyx * confx[coo2D(by, tx)])\
		         +confy[coo2D(ty, tx+1)] * ( BXMyy * confy[coo2D(ty, tx)] + BYMyy * confy[coo2D(by, tx+1)] + BWMyy * confy[coo2D(by, tx)])\
		         +confy[coo2D(ty, tx+1)] * ( BXMyz * confz[coo2D(ty, tx)] + BYMyz * confz[coo2D(by, tx+1)] + BWMyz * confz[coo2D(by, tx)])\
		         +confz[coo2D(ty, tx+1)] * ( BXMzx * confx[coo2D(ty, tx)] + BYMzx * confx[coo2D(by, tx+1)] + BWMzx * confx[coo2D(by, tx)])\
		         +confz[coo2D(ty, tx+1)] * ( BXMzy * confy[coo2D(ty, tx)] + BYMzy * confy[coo2D(by, tx+1)] + BWMzy * confy[coo2D(by, tx)])\
		         +confz[coo2D(ty, tx+1)] * ( BXMzz * confz[coo2D(ty, tx)] + BYMzz * confz[coo2D(by, tx+1)] + BWMzz * confz[coo2D(by, tx)] - A * confz[coo2D(ty, tx+1)]);
	//Bottom-right corner
	sD[y][x] -= confx[coo2D((ty+1), tx+1)] * ( BXMxx * confx[coo2D((ty+1), tx)] + BYMxx * confx[coo2D(ty, tx+1)] + BYMxx * confx[coo2D(ty, tx)])\
		         +confx[coo2D((ty+1), tx+1)] * ( BXMxy * confy[coo2D((ty+1), tx)] + BYMxy * confy[coo2D(ty, tx+1)] + BYMxy * confy[coo2D(ty, tx)])\
		         +confx[coo2D((ty+1), tx+1)] * ( BXMxz * confz[coo2D((ty+1), tx)] + BYMxz * confz[coo2D(ty, tx+1)] + BYMxz * confz[coo2D(ty, tx)])\
		         +confy[coo2D((ty+1), tx+1)] * ( BXMyx * confx[coo2D((ty+1), tx)] + BYMyx * confx[coo2D(ty, tx+1)] + BYMyx * confx[coo2D(ty, tx)])\
		         +confy[coo2D((ty+1), tx+1)] * ( BXMyy * confy[coo2D((ty+1), tx)] + BYMyy * confy[coo2D(ty, tx+1)] + BYMyy * confy[coo2D(ty, tx)])\
		         +confy[coo2D((ty+1), tx+1)] * ( BXMyz * confz[coo2D((ty+1), tx)] + BYMyz * confz[coo2D(ty, tx+1)] + BYMyz * confz[coo2D(ty, tx)])\
		         +confz[coo2D((ty+1), tx+1)] * ( BXMzx * confx[coo2D((ty+1), tx)] + BYMzx * confx[coo2D(ty, tx+1)] + BYMzx * confx[coo2D(ty, tx)])\
		         +confz[coo2D((ty+1), tx+1)] * ( BXMzy * confy[coo2D((ty+1), tx)] + BYMzy * confy[coo2D(ty, tx+1)] + BYMzy * confy[coo2D(ty, tx)])\
		         +confz[coo2D((ty+1), tx+1)] * ( BXMzz * confz[coo2D((ty+1), tx)] + BYMzz * confz[coo2D(ty, tx+1)] + BYMzz * confz[coo2D(ty, tx)] - A * confz[coo2D((ty+1), tx+1)]);
	__syncthreads();
