...
__global__ void calTRI(float *confx, float *confy, float *confz, double *out){
	...
	const int ty =(blockIdx.x / cals_BN) * cals_SpinSize * SpinSize_z +  3 * ((((blockIdx.x % cals_BN) / cals_GridSize_x) % cals_GridSize_y) * cals_BlockSize_y + y);
	const int txp = tx +1 ;
	const int typ = ty +1 ;
	const int txp2 = tx +2 ;
	const int typ2 = ty +2 ;
  ...
  for (z = 1; z < SpinSize_z; z++){
	...
	sD[threadIdx.x] = -confx[cals_coo(z, ty, tx)] * ( BXMxx * confx[cals_coo(z, ty, bx)] + BYMxx * confx[cals_coo(z, by, tx)] + BWMxx * confx[cals_coo(z, by, bx)] + BZMxx * confx[cals_coo(z-1, ty, tx)])\
	           -confx[cals_coo(z, ty, tx)] * ( BXMxy * confy[cals_coo(z, ty, bx)] + BYMxy * confy[cals_coo(z, by, tx)] + BWMxy * confy[cals_coo(z, by, bx)] + BZMxy * confy[cals_coo(z-1, ty, tx)])\
	           -confx[cals_coo(z, ty, tx)] * ( cBXMxz * confz[cals_coo(z, ty, bx)] + cBYMxz * confz[cals_coo(z, by, tx)] + cBWMxz * confz[cals_coo(z, by, bx)])\
		         -confy[cals_coo(z, ty, tx)] * ( BXMyx * confx[cals_coo(z, ty, bx)] + BYMyx * confx[cals_coo(z, by, tx)] + BWMyx * confx[cals_coo(z, by, bx)] + BZMyx * confx[cals_coo(z-1, ty, tx)])\
	...
	sD[threadIdx.x] -= confx[cals_coo(z, typ, tx)] * ( BXMxx * confx[cals_coo(z, typ, bx)] + BYMxx * confx[cals_coo(z, ty, tx)] + BWMxx * confx[cals_coo(z, ty, bx)] + BZMxx * confx[cals_coo(z-1, typ, tx)])\
		         +confx[cals_coo(z, typ, tx)] * ( BXMxy * confy[cals_coo(z, typ, bx)] + BYMxy * confy[cals_coo(z, ty, tx)] + BWMxy * confy[cals_coo(z, ty, bx)] + BZMxy * confy[cals_coo(z-1, typ, tx)])\
		         +confx[cals_coo(z, typ, tx)] * ( cBXMxz * confz[cals_coo(z, typ, bx)] + cBYMxz * confz[cals_coo(z, ty, tx)] + cBWMxz * confz[cals_coo(z, ty, bx)])\
		         +confy[cals_coo(z, typ, tx)] * ( BXMyx * confx[cals_coo(z, typ, bx)] + BYMyx * confx[cals_coo(z, ty, tx)] + BWMyx * confx[cals_coo(z, ty, bx)] + BZMyx * confx[cals_coo(z-1, typ, tx)])\
	...
	sD[threadIdx.x] -= confx[cals_coo(z, typ2, tx)] * ( BXMxx * confx[cals_coo(z, typ2, bx)] + BYMxx * confx[cals_coo(z, typ, tx)] + BWMxx * confx[cals_coo(z, typ, bx)] + BZMxx * confx[cals_coo(z-1, typ2, tx)])\
		         +confx[cals_coo(z, typ2, tx)] * ( BXMxy * confy[cals_coo(z, typ2, bx)] + BYMxy * confy[cals_coo(z, typ, tx)] + BWMxy * confy[cals_coo(z, typ, bx)] + BZMxy * confy[cals_coo(z-1, typ2, tx)])\
		         +confx[cals_coo(z, typ2, tx)] * ( cBXMxz * confz[cals_coo(z, typ2, bx)] + cBYMxz * confz[cals_coo(z, typ, tx)] + cBWMxz * confz[cals_coo(z, typ, bx)])\
		         +confy[cals_coo(z, typ2, tx)] * ( BXMyx * confx[cals_coo(z, typ2, bx)] + BYMyx * confx[cals_coo(z, typ, tx)] + BWMyx * confx[cals_coo(z, typ, bx)] + BZMyx * confx[cals_coo(z-1, typ2, tx)])\
	...
	sD[threadIdx.x] -= confx[cals_coo(z, ty, txp)] * ( BXMxx * confx[cals_coo(z, ty, tx)] + BYMxx * confx[cals_coo(z, by, txp)] + BWMxx * confx[cals_coo(z, by, tx)] + BZMxx * confx[cals_coo(z-1, ty, txp)])\
		         +confx[cals_coo(z, ty, txp)] * ( BXMxy * confy[cals_coo(z, ty, tx)] + BYMxy * confy[cals_coo(z, by, txp)] + BWMxy * confy[cals_coo(z, by, tx)] + BZMxy * confy[cals_coo(z-1, ty, txp)])\
		         +confx[cals_coo(z, ty, txp)] * ( cBXMxz * confz[cals_coo(z, ty, tx)] + cBYMxz * confz[cals_coo(z, by, txp)] + cBWMxz * confz[cals_coo(z, by, tx)])\
		         +confy[cals_coo(z, ty, txp)] * ( BXMyx * confx[cals_coo(z, ty, tx)] + BYMyx * confx[cals_coo(z, by, txp)] + BWMyx * confx[cals_coo(z, by, tx)] + BZMyx * confx[cals_coo(z-1, ty, txp)])\
	...
	sD[threadIdx.x] -= confx[cals_coo(z, typ, txp)] * ( BXMxx * confx[cals_coo(z, typ, tx)] + BYMxx * confx[cals_coo(z, ty, txp)] + BWMxx * confx[cals_coo(z, ty, tx)] + BZMxx * confx[cals_coo(z-1, typ, txp)])\
		         +confx[cals_coo(z, typ, txp)] * ( BXMxy * confy[cals_coo(z, typ, tx)] + BYMxy * confy[cals_coo(z, ty, txp)] + BWMxy * confy[cals_coo(z, ty, tx)] + BZMxy * confy[cals_coo(z-1, typ, txp)])\
		         +confx[cals_coo(z, typ, txp)] * ( cBXMxz * confz[cals_coo(z, typ, tx)] + cBYMxz * confz[cals_coo(z, ty, txp)] + cBWMxz * confz[cals_coo(z, ty, tx)])\
		         +confy[cals_coo(z, typ, txp)] * ( BXMyx * confx[cals_coo(z, typ, tx)] + BYMyx * confx[cals_coo(z, ty, txp)] + BWMyx * confx[cals_coo(z, ty, tx)] + BZMyx * confx[cals_coo(z-1, typ, txp)])\
	...
	sD[threadIdx.x] -= confx[cals_coo(z, typ2, txp)] * ( BXMxx * confx[cals_coo(z, typ2, tx)] + BYMxx * confx[cals_coo(z, typ, txp)] + BWMxx * confx[cals_coo(z, typ, tx)] + BZMxx * confx[cals_coo(z-1, typ2, txp)])\
		         +confx[cals_coo(z, typ2, txp)] * ( BXMxy * confy[cals_coo(z, typ2, tx)] + BYMxy * confy[cals_coo(z, typ, txp)] + BWMxy * confy[cals_coo(z, typ, tx)] + BZMxy * confy[cals_coo(z-1, typ2, txp)])\
		         +confx[cals_coo(z, typ2, txp)] * ( cBXMxz * confz[cals_coo(z, typ2, tx)] + cBYMxz * confz[cals_coo(z, typ, txp)] + cBWMxz * confz[cals_coo(z, typ, tx)])\
		         +confy[cals_coo(z, typ2, txp)] * ( BXMyx * confx[cals_coo(z, typ2, tx)] + BYMyx * confx[cals_coo(z, typ, txp)] + BWMyx * confx[cals_coo(z, typ, tx)] + BZMyx * confx[cals_coo(z-1, typ2, txp)])\
	...
	sD[threadIdx.x] -= confx[cals_coo(z, ty, txp2)] * ( BXMxx * confx[cals_coo(z, ty, txp)] + BYMxx * confx[cals_coo(z, by, txp2)] + BWMxx * confx[cals_coo(z, by, txp)] + BZMxx * confx[cals_coo(z-1, ty, txp2)])\
		         +confx[cals_coo(z, ty, txp2)] * ( BXMxy * confy[cals_coo(z, ty, txp)] + BYMxy * confy[cals_coo(z, by, txp2)] + BWMxy * confy[cals_coo(z, by, txp)] + BZMxy * confy[cals_coo(z-1, ty, txp2)])\
		         +confx[cals_coo(z, ty, txp2)] * ( cBXMxz * confz[cals_coo(z, ty, txp)] + cBYMxz * confz[cals_coo(z, by, txp2)] + cBWMxz * confz[cals_coo(z, by, txp)])\
		         +confy[cals_coo(z, ty, txp2)] * ( BXMyx * confx[cals_coo(z, ty, txp)] + BYMyx * confx[cals_coo(z, by, txp2)] + BWMyx * confx[cals_coo(z, by, txp)] + BZMyx * confx[cals_coo(z-1, ty, txp2)])\
	...
	sD[threadIdx.x] -= confx[cals_coo(z, typ, txp2)] * ( BXMxx * confx[cals_coo(z, typ, txp)] + BYMxx * confx[cals_coo(z, ty, txp2)] + BWMxx * confx[cals_coo(z, ty, txp)] + BZMxx * confx[cals_coo(z-1, typ, txp2)])\
		         +confx[cals_coo(z, typ, txp2)] * ( BXMxy * confy[cals_coo(z, typ, txp)] + BYMxy * confy[cals_coo(z, ty, txp2)] + BWMxy * confy[cals_coo(z, ty, txp)] + BZMxy * confy[cals_coo(z-1, typ, txp2)])\
		         +confx[cals_coo(z, typ, txp2)] * ( cBXMxz * confz[cals_coo(z, typ, txp)] + cBYMxz * confz[cals_coo(z, ty, txp2)] + cBWMxz * confz[cals_coo(z, ty, txp)])\
		         +confy[cals_coo(z, typ, txp2)] * ( BXMyx * confx[cals_coo(z, typ, txp)] + BYMyx * confx[cals_coo(z, ty, txp2)] + BWMyx * confx[cals_coo(z, ty, txp)] + BZMyx * confx[cals_coo(z-1, typ, txp2)])\
	...
	sD[threadIdx.x] -= confx[cals_coo(z, typ2, txp2)] * ( BXMxx * confx[cals_coo(z, typ2, txp)] + BYMxx * confx[cals_coo(z, typ, txp2)] + BWMxx * confx[cals_coo(z, typ, txp)] + BZMxx * confx[cals_coo(z-1, typ2, txp2)])\
		         +confx[cals_coo(z, typ2, txp2)] * ( BXMxy * confy[cals_coo(z, typ2, txp)] + BYMxy * confy[cals_coo(z, typ, txp2)] + BWMxy * confy[cals_coo(z, typ, txp)] + BZMxy * confy[cals_coo(z-1, typ2, txp2)])\
		         +confx[cals_coo(z, typ2, txp2)] * ( cBXMxz * confz[cals_coo(z, typ2, txp)] + cBYMxz * confz[cals_coo(z, typ, txp2)] + cBWMxz * confz[cals_coo(z, typ, txp)])\
		         +confy[cals_coo(z, typ2, txp2)] * ( BXMyx * confx[cals_coo(z, typ2, txp)] + BYMyx * confx[cals_coo(z, typ, txp2)] + BWMyx * confx[cals_coo(z, typ, txp)] + BZMyx * confx[cals_coo(z-1, typ2, txp2)])\
